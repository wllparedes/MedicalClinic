<div x-cloak x-data="dropzone({
    ...
    <div
        class="dz-flex p-3 rounded-md dz-flex-col dz-items-start dz-h-full dz-w-full dz-max-w-2xl dz-justify-center bg-white shadow-md text-slate-800 border-2 border-slate-300">
        ...
        <div class="mb-2 dz-flex dz-justify-between dz-w-full">
            <div x-show="isLoading" role="status">
                <svg aria-hidden="true" class="dz-w-5 dz-h-5 dz-text-gray-200 dz-animate-spin fill-cyan-600"
        ...
        <div @click="$refs.input.click()"
            class="border-2 border-dashed rounded-lg border-slate-300 dz-w-full dz-cursor-pointer">
            <div>
                <div x-show="!isDragging"
                    class="dz-flex dz-items-center bg-white border-dashed border-slate-400 dz-justify-center dz-gap-2 dz-py-8 dz-h-full">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                        class="dz-w-6 dz-h-6 text-blue-600">
                        <path
                            d="M9.25 13.25a.75.75 0 001.5 0V4.636l2.955 3.129a.75.75 0 001.09-1.03l-4.25-4.5a.75.75 0 00-1.09 0l-4.25 4.5a.75.75 0 101.09 1.03L9.25 4.636v8.614z" />
                        <path
                            d="M3.5 12.75a.75.75 0 00-1.5 0v2.5A2.75 2.75 0 004.75 18h10.5A2.75 2.75 0 0018 15.25v-2.5a.75.75 0 00-1.5 0v2.5c0 .69-.56 1.25-1.25 1.25H4.75c-.69 0-1.25-.56-1.25-1.25v-2.5z" />
                    </svg>
                    <p class="dz-text-md dz-text-gray-600 dark:dz-text-gray-400">Déjalo aquí o <span
                            class="dz-font-semibold text-slate-800 dark:dz-text-white">busca archivos</span></p>
                </div>
                <div x-show="isDragging"
                    ...
                    <p class="dz-text-md dz-text-gray-600 dark:dz-text-gray-400">Suelta aquí para subir</p>
                </div>
            </div>
        ...
        <div class="dz-flex dz-items-center dz-gap-2 dz-text-gray-500 dz-text-sm dz-mt-2">
            ...
            @if ($hasMaxFileSize)
                <p>{{ __('Hasta :size', ['size' => \Illuminate\Support\Number::fileSize($this->maxFileSize * 1024)]) }}
                </p>
            @endif
        ...
        @if (count($files) > 0)
            <div class="dz-flex dz-flex-wrap dz-gap-x-10 dz-gap-y-2 dz-justify-start dz-w-full dz-mt-5">
                @foreach ($files as $file)
                    <div
                        class="dz-flex dz-items-center dz-justify-between dz-gap-2 dz-border dz-rounded border-slate-300 dz-w-full dz-h-auto dz-overflow-hidden">
                        <div class="dz-flex dz-items-center dz-gap-3">
                            ...
                            <div class="dz-flex dz-flex-col dz-items-start dz-gap-1">
                                <div
                                    class="dz-text-center text-slate-800 dz-text-sm dz-font-medium dark:dz-text-slate-100">
                                    {{ $file['name'] }}</div>
                        ...
                        <div class="dz-flex dz-items-center dz-mr-3">
                            <button type="button" @click="removeUpload('{{ $file['tmpFilename'] }}')">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                    class="dz-w-6 dz-h-6 text-slate-800 dark:dz-text-white">
                                    <path fill-rule="evenodd"
